...
keymap("n", "<leader>yip", '"+yip<CR>', opts)
keymap("n", "<leader>yiW", '"+yiW<CR>', opts)
keymap("n", "<leader>yiw", '"+yiw<CR>', opts)
keymap("n", "<leader>yit", '"+yit<CR>', opts)
keymap("n", "<leader>yi(", '"+yi(<CR>', opts)
keymap("n", "<leader>yi)", '"+yi)<CR>', opts)
keymap("n", "<leader>yi{", '"+yi{<CR>', opts)
keymap("n", "<leader>yi}", '"+yi}<CR>', opts)
keymap("n", "<leader>yi<", '"+yi<<CR>', opts)
...
keymap("n", "<leader>yap", '"+yap<CR>', opts)
keymap("n", "<leader>yaW", '"+yaW<CR>', opts)
keymap("n", "<leader>yaw", '"+yaw<CR>', opts)
keymap("n", "<leader>yat", '"+yat<CR>', opts)
keymap("n", "<leader>ya(", '"+ya(<CR>', opts)
keymap("n", "<leader>ya)", '"+ya)<CR>', opts)
keymap("n", "<leader>ya{", '"+ya{<CR>', opts)
keymap("n", "<leader>ya}", '"+ya}<CR>', opts)
keymap("n", "<leader>ya<", '"+ya<<CR>', opts)
